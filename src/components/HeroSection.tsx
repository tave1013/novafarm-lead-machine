      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
          <div className="mb-8 lg:mb-0">
            ...
            <button className="bg-[#078147] text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-[#066139] transition-all transform hover:scale-105 shadow-lg">
            ...
            <div className="bg-gradient-to-br from-[#078147]/10 to-[#f4f1ea] rounded-2xl p-8">
              <div className="bg-white rounded-xl shadow-2xl p-6">
                ...
                <div className="space-y-3">
                  <div className="h-4 bg-[#078147]/20 rounded"></div>
              ...
              {/* Mobile mockup */}
              <div className="absolute -bottom-4 -right-4 bg-white rounded-2xl shadow-xl p-4 w-32">
