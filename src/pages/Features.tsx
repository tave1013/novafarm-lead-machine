...
const Features = () => {
  const features = [
    ...
    {
      id: 'dashboard',
      title: 'NovaFarm Dashboard',
      icon: <Users className="w-6 h-6 text-[#078147]" />,
      description: 'A modern, intuitive dashboard that gives you a complete overview of your pharmacy’s daily operations, appointments, revenue, and customer interactions.',
      detailedDescription: 'Our dashboard provides real-time insights into your pharmacy’s performance, upcoming appointments, quick stats, and recent activities. Designed for ease of use, it helps your team stay organized and informed throughout the day.',
      benefits: [
        ...
        'Customizable for your pharmacy’s needs'
      ],
      mockup: (
        <div className="w-full max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border">
            ...
            <div className="bg-gray-50 px-6 py-4 border-b flex items-center space-x-4">
              ...
              <div className="text-sm text-gray-500 font-medium">NovaFarm Dashboard - Farmacia Centrale</div>
            </div>
            
            {/* Main dashboard content */}
            <div className="flex">
              {/* Sidebar */}
              <div className="w-56 bg-[#078147] text-white p-6">
                ...
                <nav className="space-y-1">
                  <div className="flex items-center space-x-3 text-white bg-white/20 rounded-lg px-3 py-2">
                    <Users className="w-4 h-4" />
                    <span className="text-sm font-medium">Dashboard</span>
                  </div>
                  <div className="flex items-center space-x-3 text-white/80 hover:text-white px-3 py-2 rounded-lg hover:bg-white/10 transition-colors">
                    <Calendar className="w-4 h-4" />
                    <span className="text-sm">Calendario</span>
                  </div>
                  <div className="flex items-center space-x-3 text-white/80 hover:text-white px-3 py-2 rounded-lg hover:bg-white/10 transition-colors">
                    <MessageSquare className="w-4 h-4" />
                    <span className="text-sm">Chat Unificata</span>
                  </div>
                  <div className="flex items-center space-x-3 text-white/80 hover:text-white px-3 py-2 rounded-lg hover:bg-white/10 transition-colors">
              ...
              <div className="flex-1 p-6 bg-gray-50">
                {/* Header */}
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-gray-800 mb-2">Benvenuto, Dr. Rossi</h2>
                  <p className="text-gray-600">Ecco un riepilogo della tua farmacia oggi</p>
                </div>
                  ...
                  <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Appuntamenti Oggi</div>
                      </div>
                      <Calendar className="w-8 h-8 text-[#078147]/30" />
                    </div>
                  </div>
                  <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Incassi Oggi</div>
                      </div>
                      <CreditCard className="w-8 h-8 text-blue-600/30" />
                    </div>
                  </div>
                  <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                    <div className="flex items-center justify-between">
                      ...
                      <Star className="w-8 h-8 text-yellow-600/30" />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 bg-[#078147]/5 rounded-lg border-l-4 border-[#078147]">
                        <div>
                          <div className="font-medium text-gray-800">Maria Rossi</div>
                          <div className="text-sm text-gray-600">Consulenza farmaceutica</div>
                        </div>
                        <div className="text-sm font-medium text-[#078147]">09:30</div>
                      </div>
                      <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border-l-4 border-blue-500">
                        <div>
                          <div className="font-medium text-gray-800">Giuseppe Verdi</div>
                          <div className="text-sm text-gray-600">Vaccinazione</div>
                        </div>
                        <div className="text-sm font-medium text-blue-600">11:00</div>
                      </div>
                      <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg border-l-4 border-yellow-500">
                        <div>
                          <div className="font-medium text-gray-800">Anna Bianchi</div>
                          <div className="text-sm text-gray-600">Check-up pressione</div>
                        </div>
                        <div className="text-sm font-medium text-yellow-600">14:30</div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <div className="flex justify-between text-sm mb-1">
                          <span className="text-gray-600">Presenze Appuntamenti</span>
                          <span className="font-medium">94%</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div className="bg-[#078147] h-2 rounded-full" style={{width: '94%'}}></div>
                        </div>
                      </div>
                      <div>
                        <div className="flex justify-between text-sm mb-1">
                          <span className="text-gray-600">Soddisfazione Clienti</span>
                      ...
                      <div className="pt-2">
                        <div className="text-center p-3 bg-[#078147]/10 rounded-lg">
                          <div className="text-lg font-bold text-[#078147]">+23%</div>
                          <div className="text-xs text-gray-600">Prenotazioni vs mese scorso</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-6 bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3 p-2">
                      ...
                      <span className="text-sm text-gray-700">Nuova prenotazione da Maria R. per domani alle 10:00</span>
                      <span className="text-xs text-gray-500 ml-auto">2 min fa</span>
                    </div>
                    <div className="flex items-center space-x-3 p-2">
                      <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                      <span className="text-sm text-gray-700">Nuova recensione 5 stelle ricevuta</span>
                      <span className="text-xs text-gray-500 ml-auto">8 min fa</span>
                    </div>
                    <div className="flex items-center space-x-3 p-2">
                      <div className="w-2 h-2 bg-yellow-500 rounded-full"></div>
                      <span className="text-sm text-gray-700">Pagamento ricevuto - €45 da Giuseppe V.</span>
                      <span className="text-xs text-gray-500 ml-auto">15 min fa</span>
                    </div>
                  </div>
                </div>
              </div>
    ...
    },
    {
      ...
      detailedDescription: 'Integrate with Stripe to allow customers to pre-pay for appointments securely. This reduces no-shows and streamlines your payment process.',
      benefits: [
    ...
    },
    {
      ...
      detailedDescription: 'Gain valuable insights into your business with comprehensive analytics and reporting tools. Monitor bookings, revenue, customer satisfaction, and more.',
      benefits: [
    ...
    },
    {
      ...
      detailedDescription: 'Our support team is available 7 days a week to assist you. Access onboarding videos, live chat, and a comprehensive help center to get the most out of NovaFarm.',
      benefits: [
